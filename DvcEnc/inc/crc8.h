//小小白
//參考自http://www.koders.com/zeitgeist/c/
#ifndef __CRC8_H__
#define __CRC8_H__

#define CRC8_INIT_VALUE			0x00
#define CRC8_FINALXOR_VALUE		0x00
...
//crc table for a byte-wise 8-bit CRC calculation on the polynomial:
//x^8 + x^2 + x^1 + x^0
